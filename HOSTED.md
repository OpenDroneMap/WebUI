...
Pick a cloud service provider (e.g. [DigitalOcean](https://www.digitalocean.com/)) and [install OpenDroneMap WebUI](https://docs.webodm.org/installation/#google-compute-amazon-aws). Then import your tasks on the newly created instance in order to share links with others.
