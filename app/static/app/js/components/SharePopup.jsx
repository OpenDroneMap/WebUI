          ...
          <div className={"share-links " + (isPublic ? "show" : "")}>
            {this.showLocalLinkAlert() ? 
              <div className="alert alert-warning alert-dismissable link-alert">
                ...
                <span dangerouslySetInnerHTML={{__html: interpolate(_("The link below is accessible only within your local network. To share a link with others online, use a %(service)s"), {service: `<a href="https://github.com/OpenDroneMap/WebUI/blob/main/HOSTED.md" target="_blank">${_("hosted instance")}</a>`})}}></span>
              </div>
            : ""}
