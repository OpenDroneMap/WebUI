...
usage(){
  ...
  echo
  echo "This program manages the background worker processes. OpenDroneMap WebUI requires at least one background process worker to be running at all times."
  echo 
  echo "Command list:"
